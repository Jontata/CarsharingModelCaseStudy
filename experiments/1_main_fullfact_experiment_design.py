...
# held constant
L_options = [0, 1, 2]                               # Fee-levels. CONSTANT.

## customer preferences
beta_C_k_options = [-1.15, -1, -0.85]               # Cost sensitivity
beta_V_k_options = [-0.30, -0.25, -0.10]            # Vehicle time sensitivity
beta_P_k_options = [-0.45, -0.30, -0.15]            # Public transit time sensitivity
...
if __name__ in "__main__":
    ...
    experiment_df.to_csv('results/experiment_results_t1.csv', index=False, sep=';', encoding='utf-8')